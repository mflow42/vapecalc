...
import { aromsListFlavourArt } from '../01_Atoms/aromsList'
...
class ListAromsMoleculeFlavourArt extends Component {
  constructor(props) {
    super(props);
    this.state = {};
...
export default connect(state => ({ aromsInCalc: state.aromsInCalc, aromsListFlavourArt: state.aromsList.aromsListFlavourArt }), { aromAdd, aromRemove, aromToggleSelection })(ListAromsMoleculeFlavourArt)
