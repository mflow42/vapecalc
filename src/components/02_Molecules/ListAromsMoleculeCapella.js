...
import { aromsListCapella } from '../01_Atoms/aromsList'
...
class ListAromsMoleculeCapella extends Component {
  constructor(props) {
    super(props);
    this.state = {};
...
export default connect(state => ({ aromsInCalc: state.aromsInCalc, aromsListCapella: state.aromsList.aromsListCapella }), { aromAdd, aromRemove, aromToggleSelection })(ListAromsMoleculeCapella)
