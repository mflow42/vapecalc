...
import Recipepick from '../03_Organisms/Recipepick';
      ...
      <Router>
        <div>
            <Menu
              mode='horizontal'
            >
              <Menu.Item active ><Link to="/main"><Icon type="calculator" />Калькулятор</Link></Menu.Item>
              ...
              <SubMenu title={<span><Icon type="share-alt" />Рецепты</span>}>
                ...
                <Menu.Item><Link to={`${match.url}/recipepick`}>Подбор рецептов</Link></Menu.Item>
              </SubMenu>
            ...
            <Route exact path="/main" component={Calculator} />
            ...
            <Route path={`${match.url}/recipepick`} component={Recipepick} />
